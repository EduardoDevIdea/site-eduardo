...
<html lang="en">
    ...
    <meta name="viewport" content="width=device-width, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no">
     ...
     <!-- Site Metas -->
    <title>Site - Eduardo Gomes</title>  
...
<body id="page-top" class="politics_version">
		...
		<div class="heading">
			...
			<!--h3 class="cd-headline clip is-full-width">
				...
				<span class="cd-words-wrapper">
					<b class="is-visible">Criatividade</b>
					<b>Organização</b>
					<b>Comprometimento</b>
					<b>Qualidade</b>
				</span>
    ...
    <!-- "EFEITO" DE NUVEM QUE DIVIDE SECTIONS-->
    ...
    <!-- PROJETOS -->
	<div id="projetos" class="section lb">
		<div class="container">
			<div class="section-title text-left">
                <h3>PROJETOS</h3>
                <p>Aqui estão alguns projetos que eu já executei</p>
            </div><!-- end title -->
				...
				<div class="col-md-4 col-sm-6 col-lg-4">
					<div class="post-box">
						...
						<div class="post-info">
							...
							<p>Sistema de para elaborar orçamento de forma prática, padronizada, gerenciar dados dos clientes e acompanhar andamento do serviço.</p>
						</div>
					</div>
				</div>
				<div class="col-md-4 col-sm-6 col-lg-4">
    ...
    <!-- A DEFINIR -->
    <!-- Definir se vai ser usada essa section -->
	<!-- div id="adefinir" class="section lb">
		<div class="container">
			<div class="section-title text-left">
                <h3>Portifólio</h3>
    ...
    <!-- SERVIÇOS -->
    <div id="services" class="section lb" style="background-color: white;">
        <div class="container">
            <div class="section-title text-left">
                <h3>Serviços</h3>
                <p>Algumas das atividades que tenho me aprimorado</p>
            </div><!-- end title -->
            ...
            <div class="row">
				<div class="col-md-4">
                    <div class="services-inner-box">
						...
						<p>
                            Construção de sites, paineis administrativos, aplicações para seu negócio que 
                ...
                <div class="col-md-4">
                    <div class="services-inner-box">
						...
						<p>
                            As aplicações tem design reposponsivo, adaptando-se ao tamanho da tela do
                            dispositivo que está sendo utilizado, mantendo a organização dos elementos.
                        </p>
					</div>
                </div><!-- end col -->
				...
				<div class="col-md-4">
                    <div class="services-inner-box">
						...
						<h2>Web Idea</h2>
						<p>
                            A análise da necessidade e elaboração da aplicação são feitas de maneira
                            que o produto final seja satisfatório para o cliente.
                        </p>
					</div>
                </div><!-- end col -->
                ...
                <div class="col-md-4">
                    <div class="services-inner-box">
						...
						<h2>Support</h2>
						<p>
                            Tão importante quanto a entrega do produto, é o suporte dado a ele
                            com a finalidade de manter a qualidade da aplicação e realizar novas implementações.
                        </p>
					</div>
                </div><!-- end col -->
